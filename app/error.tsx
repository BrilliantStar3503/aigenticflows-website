...
export default function ErrorPage({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-white px-8 text-center">
      ...
      <span className="mt-6 text-[10.5px] font-bold uppercase tracking-wider text-brand-red">500</span>
      <h1 className="mt-2 text-[32px] font-bold tracking-tight text-neutral-900">Something went wrong</h1>
