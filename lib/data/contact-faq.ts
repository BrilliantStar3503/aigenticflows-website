export const CONTACT_FAQ_ITEMS = [
  {
    ...
    answer:
      "Most teams are fully onboarded within 1–2 weeks, depending on the complexity of your workflows and data migration.",
  },
  {
    question: "Do you support migrations?",
    answer: "Yes. Our onboarding team helps you migrate contacts, clients, and historical data from your existing CRM.",
  },
  {
